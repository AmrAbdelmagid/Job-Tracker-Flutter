import 'package:job_tracker_flutter/app/home/entries/entries_list_tile.dart';
import 'package:job_tracker_flutter/app/home/entries/entry_job.dart';
  ...
  static List<EntryJob> _entriesJobsCombiner(
    ...
    return entries.map((entry) {
      final job = jobs.firstWhere(
        ...
        // orElse: () => Job(name: '', ratePerHour: '', jobId: ''),
      );
